...
use App\Repositories\CartRepository;//Es necesario edicion especial
...
class EncargoAPIController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($payment['payment']) && $payment['payment']['method']) {
            ...
            }else if ($payment['payment']['method'] == "Al recibir" || $payment['payment']['method'] == "En línea") {
            ...
            return'No entro en las opciones';
            // return $request->all();
    ...
    private function cashPaymentEncargo(Request $request)
    {
        ...
        // return $request->all();
            ...
            if($paymentTmp['payment']['method'] == "En línea"){
