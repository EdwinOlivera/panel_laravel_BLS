...
class CartAPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse($carts->toArray(), 'Carts Conseguido successfully');
    }
    ...
    public function count(Request $request)
    {
        ...
        return $this->sendResponse($count, 'Count Conseguido successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse($cart->toArray(), 'Cart conseguido successfully');
    }
    /**
